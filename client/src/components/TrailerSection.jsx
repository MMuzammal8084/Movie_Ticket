    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden '>
      ...
      <div className='relative mt-6'>
        ...
        <ReactPlayer
          ...
          controls={false}
          className='mx-auto max-w-full z-10'
          width='960px'
          height='540px'
        />
      </div>
      ...
      <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
        {dummyTrailers.map((trailer) => (
          <div
            key={trailer.image}
            className='relative transition duration-300 hover:-translate-y-1 cursor-pointer'
            onClick={() => setCurrentTrailer(trailer)}
          >
            <img
              src={trailer.image}
              alt='Trailer'
              className='rounded-lg w-full h-full object-cover brightness-75 cursor-pointer'
            />
            <PlayCircleIcon
              strokeWidth={1.6}
