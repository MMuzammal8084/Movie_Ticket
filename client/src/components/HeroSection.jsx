  ...
  return (
    ...
    >
      ...
      <p className="max-w-md text-gray-300">
        ...
        Quis aliquam doloribus excepturi totam nihil rerum adipisci provident
        similique aperiam velit at, suscipit voluptate non iste vitae!
      </p>

      <button className="flex items-center gap-1 px-6 py-3 text-sm bg-primary 
      hover:bg-primary-dull transition rounded-full font-medium cursor-pointer" onClick={()=> {navigate('./Movies'); scrollTo(0,0)}}>
        Explore Movies
